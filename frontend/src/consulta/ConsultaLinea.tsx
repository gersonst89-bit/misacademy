...
function getTipoCertificadoLabel(tipo: string | null | undefined): string {
  if (!tipo) return '—';
  if (tipo === 'adicional' || tipo === 'Certificado Adicional') return 'Certificado Adicional';
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        <div className="text-center mb-16 pt-8">
          ...
          <p className="text-base md:text-lg text-gray-400 max-w-2xl mx-auto font-light leading-relaxed">
            Para buscar por nombre, ingresa al menos tu nombre y un apellido. Para una validación
            exacta, utiliza el código del certificado o DNI.
          </p>
        </div>
