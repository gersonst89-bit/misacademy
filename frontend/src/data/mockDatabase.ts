...
export const mockLineasAcademicas: LineaAcademica[] = [
  {
    ...
    nombre: 'MIS DEV',
    descripcion:
      'Formación integral en desarrollo de software y programación para construir aplicaciones completas.',
    imagen:
  ...
  },
  {
    ...
    nombre: 'MIS IA',
    descripcion:
      'Especialización en Inteligencia Artificial y Machine Learning para resolver problemas complejos y crear soluciones inteligentes.',
    imagen:
  ...
  },
  {
    ...
    nombre: 'MIS TEACHER',
    descripcion:
      'Desarrollo de habilidades pedagógicas y herramientas educativas para formar profesionales en el ámbito educativo.',
    imagen:
      'https://images.unsplash.com/photo-1589395937658-0557e7d89fad?q=80&w=1412&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    estado: 'Publicado',
    fecha_creacion: '2024-02-01T00:00:00',
    fecha_actualizacion: null,
  },
  {
    ...
    nombre: 'MIS BUSINESS',
    descripcion:
      'Capacitación en estrategias de negocio, emprendimiento y gestión para crear empresas exitosas en el mercado actual.',
    imagen:
...
export const mockRutasAcademicas: RutaAcademica[] = [
  ...
  },
  {
    ...
    imagen:
      'https://images.unsplash.com/photo-1666597107756-ef489e9f1f09?q=80&w=1932&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    horas_totales: 120,
    nivel: 'Avanzado',
    precio: 249.99,
    estado: 'Activa',
  ...
  },
  {
    ...
    id_linea_academica: 1,
    imagen:
      'https://images.unsplash.com/photo-1627398242454-45a1465c2479?q=80&w=1374&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    horas_totales: 150,
    nivel: 'Intermedio',
    precio: 149.99,
    estado: 'Activa',
  ...
  },
  {
    ...
    id_linea_academica: 2,
    imagen:
      'https://images.unsplash.com/photo-1694903110330-cc64b7e1d21d?q=80&w=1932&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    horas_totales: 180,
    nivel: 'Avanzado',
    precio: 279.99,
    estado: 'Activa',
...
export const mockCursos: Curso[] = [
  {
    ...
    imagen:
      'https://images.unsplash.com/photo-1487058792275-0ad4aaf24ca7?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    duracion: '180',
    precio: 99.99,
    nivel: 'Intermedio',
    estado: 'Publicado',
  ...
  },
  {
    ...
    imagen:
      'https://images.unsplash.com/photo-1592609930961-219235eded71?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    duracion: '140',
    precio: 89.99,
    nivel: 'Intermedio',
    estado: 'Publicado',
...
export const mockModulos: Modulo[] = [
  {
    id_modulo: 1,
    id_curso: 1,
    titulo: 'Introducción a Fullstack',
    descripcion: null,
    orden: 1,
    estado: 'Activo',
    fecha_creacion: '2024-01-01T00:00:00',
  ...
  },
  {
    id_modulo: 4,
    id_curso: 3,
    titulo: 'Introducción a los Agentes IA',
    descripcion: null,
    orden: 1,
    estado: 'Activo',
    fecha_creacion: '2024-03-01T00:00:00',
  ...
  },
  {
    id_modulo: 6,
    id_curso: 4,
    titulo: 'Introducción al Frontend',
    descripcion: null,
    orden: 1,
    estado: 'Activo',
    fecha_creacion: '2024-03-01T00:00:00',
...
export const mockLecciones: Leccion[] = [
  {
    ...
    descripcion: null,
    url_video: 'https://www.youtube.com/embed/video1',
    duracion: 15,
    orden: 1,
    estado: 'Publicado',
    fecha_creacion: '2024-01-01T00:00:00',
  ...
  },
  {
    id_leccion: 2,
    id_modulo: 2,
    titulo: 'Configurar un servidor Express',
    descripcion: null,
    url_video: null,
    duracion: 30,
    orden: 1,
  ...
  },
  {
    id_leccion: 3,
    id_modulo: 3,
    titulo: 'Base de datos con MongoDB',
    descripcion: null,
    url_video: 'https://www.youtube.com/embed/video2',
    duracion: 40,
    orden: 1,
    estado: 'Publicado',
    fecha_creacion: '2024-02-01T00:00:00',
  ...
  },
  {
    id_leccion: 5,
    id_modulo: 5,
    titulo: 'Desarrollando un Agente',
    descripcion: null,
    url_video: 'https://www.youtube.com/embed/video3',
    duracion: 60,
    orden: 1,
    estado: 'Publicado',
    fecha_creacion: '2024-04-01T00:00:00',
  ...
  },
  {
    ...
    descripcion: null,
    url_video: 'https://www.youtube.com/embed/video4',
    duracion: 50,
    orden: 1,
    estado: 'Publicado',
    fecha_creacion: '2024-04-01T00:00:00',
...
export const mockInscripciones: Inscripcion[] = [
  {
    ...
    id_usuario: 2,
    id_curso: 1,
    fecha_inscripcion: '2025-07-10T10:00:00',
    estado: 'Activo',
    progreso_total: 25.0,
  ...
  },
  {
    ...
    id_usuario: 2,
    id_curso: 2,
    fecha_inscripcion: '2024-09-01T09:00:00',
    estado: 'Completado',
    progreso_total: 100.0,
    fecha_completado: '2025-01-10T12:00:00',
  },
];
...
export const mockProgresoEstudiante: ProgresoEstudiante[] = [
  {
    ...
    ultima_actividad: '2025-09-20T11:00:00',
    fecha_completado: null,
  },
  {
    id_progreso: 2,
    ...
    id_leccion: 3,
    estado: 'Completado',
    tiempo_visualizacion: 600,
    porcentaje_completado: 100.0,
    ultima_actividad: '2025-01-10T12:00:00',
    fecha_completado: '2025-01-10T12:00:00',
  },
];
...
export const mockEvaluaciones: Evaluacion[] = [
  {
    id_evaluacion: 1,
    id_curso: 1,
    titulo: 'Quiz Semana 1',
    descripcion: null,
    puntuacion_requerida: 70.0,
    duracion: 30,
    intentos_maximos: 2,
    estado: 'Activo',
    fecha_creacion: '2025-01-05T00:00:00',
    fecha_actualizacion: null,
  },
];
...
export const mockPreguntas: Pregunta[] = [
  {
    id_pregunta: 1,
    id_evaluacion: 1,
    texto_pregunta: '¿Qué es un agente autónomo?',
    tipo: 'Texto libre',
    puntos: 5,
    orden: 1,
  },
  {
    id_pregunta: 2,
    id_evaluacion: 1,
    texto_pregunta: '¿Cuál es la librería para interfaces de React?',
...
export const mockIntentosEvaluacion: IntentoEvaluacion[] = [
  {
    ...
    id_usuario: 2,
    id_evaluacion: 1,
    fecha_inicio: '2025-07-11T09:00:00',
    fecha_finalizacion: '2025-07-11T09:20:00',
    calificacion: 85.0,
    intento_numero: 1,
    estado: 'Completado',
  },
...
export const mockPagos: Pago[] = [
  {
    ...
    id_tipo_pago: 1,
    monto: 60.0,
    fecha_pago: '2025-07-10T10:05:00',
    estado: 'Completado',
...
export const mockCarritoCompras: CarritoCompras[] = [
  {
    id_carrito: 1,
    id_usuario: 2,
    fecha_creacion: '2025-07-10T09:50:00',
    fecha_actualizacion: '2025-07-10T09:55:00',
    estado: 'Activo',
  },
];
...
export const mockCertificaciones: Certificacion[] = [
  {
    ...
    id_usuario: 2,
    id_curso: 2,
    fecha_emision: '2025-01-11T12:00:00',
    codigo_certificado: 'CERT-0001',
    calificacion_final: 95.0,
    url_certificado: 'https://example.com/cert/1',
...
export const mockResenas: Resena[] = [
  {
    ...
    id_curso: 1,
    calificacion: 5,
    comentario: 'Excelente curso práctico.',
    fecha_resena: '2025-07-12T15:00:00',
  },
];
...
export const mockComentariosLeccion: ComentarioLeccion[] = [
  {
    ...
    id_usuario: 2,
    id_leccion: 1,
    comentario: 'Gran explicación',
    fecha_comentario: '2025-07-12T15:30:00',
...
export const mockNotificaciones: Notificacion[] = [
  {
    ...
    tipo: 'Sistema',
    leida: false,
    fecha_creacion: '2025-07-10T10:00:00',
    fecha_leida: null,
  },
];
...
export const mockTokensUsuario: TokenUsuario[] = [
  {
    ...
    fecha_expiracion: '2025-07-08T00:00:00',
    usado: false,
  },
];
...
export const mockSesionesUsuario: SesionUsuario[] = [
  {
    ...
    payload: '{"uid":2}',
    ultimo_acceso: '2025-09-20T11:00:00',
  },
];
...
export const mockMateriales: Material[] = [
  {
    id_material: 1,
    id_modulo: 1,
    nombre: 'Guía instalación',
    descripcion: 'PDF paso a paso',
    url_archivo: 'https://via.placeholder.com/file.pdf',
    tamanio: 512,
    estado: 'Publicado',
    fecha_creacion: '2025-01-10T00:00:00',
  },
  {
    id_material: 2,
    id_modulo: 1,
    nombre: 'Slides Intro React',
    descripcion: null,
    url_archivo: 'https://via.placeholder.com/slides.ppt',
    tamanio: 1024,
    estado: 'Publicado',
    fecha_creacion: '2024-08-02T00:00:00',
  },
];
...
export const mockContactos: Contacto[] = [
  {
    ...
    mensaje: 'No puedo acceder al curso.',
    fecha_envio: '2025-07-11T09:00:00',
    estado: 'Pendiente',
  ...
  },
  {
    ...
    telefono: null,
    asunto: 'Factura',
    mensaje: 'Solicito factura del pago.',
    fecha_envio: '2025-06-01T08:00:00',
    estado: 'Respondido',
    fecha_respuesta: '2025-06-02T10:00:00',
    respuesta: 'Enviada por correo',
  },
];
