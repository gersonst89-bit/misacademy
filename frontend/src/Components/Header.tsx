...
function Header() {
  ...
  return (
    <>
      ...
      <header
        className={`w-full z-[100] transition-all duration-500 fixed top-0 left-0 right-0 border-b border-white/[0.05] ${
          scrolled || !isHomePage 
              ...
              {[
                ...
                return (
                  <Link 
                    ...
                    className={`px-5 py-2 text-[10px] font-bold tracking-[0.15em] uppercase rounded-lg transition-all duration-300 relative group flex items-center gap-2.5 ${
