...
export default function CursosDestacadosHome() {
  ...
  if (loading) {
    return (
      <section
        ref={sectionRef}
        className="py-24 px-6 lg:px-8 bg-[#03070c] relative overflow-hidden flex flex-col items-center justify-center min-h-[400px]"
      >
  ...
  return (
    <section
      ref={sectionRef}
      id="cursos"
      className="py-24 px-6 lg:px-8 bg-[#03070c] relative overflow-hidden"
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-16 relative">
          ...
          <p className="text-base text-slate-400 max-w-2xl mx-auto leading-relaxed">
            Descubre los programas y cursos de especialización con mayor demanda tecnológica,
            diseñados para impulsar tu perfil profesional hacia el siguiente nivel.
          </p>
        </div>
