...
import { BookOpen, Cpu, Users, Award, ArrowRight, Zap } from 'lucide-react';
...
const Metodologia: React.FC = () => {
  const steps: MethodologyStep[] = [
    {
      ...
      description:
        'Domina los fundamentos con contenido curado por expertos y optimizado para la retención cognitiva.',
    ...
    },
    {
      ...
      description:
        'Aprende haciendo. Desarrolla proyectos reales con tecnologías de vanguardia y flujos de trabajo profesionales.',
    ...
    },
    {
      ...
      description:
        'No estás solo. Accede a mentorías personalizadas y colabora con una comunidad de alto rendimiento.',
    ...
    },
    {
      ...
      description:
        'Obtén certificaciones con valor internacional que validan tu expertise ante las mejores empresas IT.',
  ...
  return (
    <section
      id="metodologia"
      className="relative pt-12 pb-24 lg:pb-32 overflow-hidden bg-transparent px-6 metodologia-rustica"
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-20">
          ...
          >
            Combinamos ingeniería educativa avanzada con práctica intensiva para acelerar tu
            crecimiento profesional en tiempo récord.
          </motion.p>
        </div>
          ...
          {steps.map((step, index) => (
            ...
            >
              ...
              <div className="h-full p-8 rounded-[2.5rem] bg-white/[0.02] border border-white/5 backdrop-blur-3xl overflow-hidden flex flex-col transition-all duration-500 group-hover:bg-white/[0.05] group-hover:border-white/20">
                {/* Glow Effect */}
                <div
                  className={`absolute -top-24 -right-24 w-48 h-48 bg-gradient-to-br ${step.color} opacity-0 group-hover:opacity-10 blur-[60px] transition-opacity duration-500`}
                />

                {/* Icon Container */}
                <div
                  className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${step.color} p-[1px] mb-8 shadow-lg ${step.glow} group-hover:scale-110 transition-transform duration-500`}
                >
