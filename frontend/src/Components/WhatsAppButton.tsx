...
export default function WhatsAppButton() {
  ...
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.94 }}
      className="fixed bottom-[100px] right-5 sm:bottom-[110px] sm:right-7 z-[9990] group"
      aria-label="Contactar por WhatsApp"
      id="whatsapp-floating-button"
    >
      <div className="absolute inset-0 bg-emerald-500 blur-xl opacity-30 group-hover:opacity-50 transition-opacity duration-300 rounded-2xl" />

      <div className="relative w-[52px] h-[52px] sm:w-[56px] sm:h-[56px] bg-gradient-to-br from-emerald-500 to-green-600 text-white rounded-2xl shadow-[0_10px_30px_rgba(16,185,129,0.3)] flex items-center justify-center border border-white/15">
        <svg
