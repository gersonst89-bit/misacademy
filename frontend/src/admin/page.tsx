  ...
  `}
            >
              ...
              <nav className="flex-1 px-4 space-y-1 overflow-y-auto sidebar-scrollbar pb-8 relative z-10">
                ...
                <Link
                  to="/"
                  className={`flex items-center justify-between w-full px-5 py-4 rounded-xl bg-gradient-to-r from-sky-500/10 to-transparent border border-sky-500/20 text-sky-400 hover:from-sky-500/20 transition-all duration-500 mb-6 group ${
