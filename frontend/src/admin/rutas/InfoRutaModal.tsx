  ...
  useEffect(() => {
    const fetchLinea = async () => {
      ...
      try {
        ...
        const linea = lista.find(
          (l: any) => Number(l.id_linea_academica) === Number(ruta.id_linea_academica),
        );
      ...
      <div className="space-y-6 md:space-y-8">
        ...
        <div className="relative h-48 md:h-56 rounded-[2rem] md:rounded-[2.5rem] overflow-hidden shadow-2xl group border border-white/10">
          {ruta.imagen ? (
            ...
            <div className="w-full h-full bg-slate-100 flex items-center justify-center text-slate-400 font-black uppercase tracking-widest text-xs">
              Sin imagen
            </div>
          )}
          ...
          <div className="bg-slate-50/40 p-5 md:p-6 rounded-[1.5rem] md:rounded-[2rem] border border-slate-100/50 space-y-4 md:space-y-6">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div className="flex flex-col">
                <h4 className="text-[9px] md:text-[10px] font-black uppercase tracking-[0.2em] text-slate-500 mb-0.5">
                  Información
                </h4>
                <span className="text-[13px] md:text-[14px] font-black text-slate-900 tracking-tight">
                  Descripción de Ruta
                </span>
              </div>
            </div>
            ...
            <div className="space-y-4 md:space-y-5">
              <div>
                ...
                <p className="text-[12px] md:text-[13px] text-slate-600 leading-relaxed mt-1.5 font-medium">
