    ...
    <div className="space-y-6 md:space-y-8 animate-fadeIn max-w-5xl mx-auto py-4 md:py-8 px-4">
      ...
      <div className="bg-white rounded-[2rem] md:rounded-[3rem] shadow-sm border border-gray-100 p-6 md:p-10 flex flex-col items-center relative overflow-hidden group">
        ...
        <div className="mt-4 md:mt-6 text-center">
          <h1 className="text-xl md:text-2xl font-black text-[#0E1C2B]">
            {form.nombre} {form.apellido}
          </h1>
          <p className="text-[10px] md:text-xs font-black text-sky-500 uppercase tracking-[0.3em] mt-1">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8">
        ...
        <div className="lg:col-span-2 space-y-6 bg-white p-6 md:p-10 rounded-[2rem] md:rounded-[3rem] shadow-sm border border-gray-100">
          <div className="flex items-center gap-3 mb-4 md:mb-6">
            <div className="w-8 h-8 md:w-10 md:h-10 bg-sky-50 text-sky-500 rounded-xl md:rounded-2xl flex items-center justify-center shadow-sm">
              <IoPersonOutline size={18} className="md:size-[22px]" />
            </div>
            <h2 className="text-[11px] md:text-sm font-black text-[#0E1C2B] uppercase tracking-widest">
              Detalles Personales
            </h2>
          </div>
          ...
          <div className="mt-6 md:mt-8">
            <label className="block text-[10px] md:text-[11px] font-black text-gray-400 uppercase tracking-widest mb-3 ml-1">
              Semblanza Profesional / Biografía
            </label>
            <textarea
          ...
          {mensaje && (
            <p className="text-center text-[9px] md:text-[10px] font-black text-emerald-500 uppercase tracking-widest mt-4">
              ✓ {mensaje}
            </p>
          )}
          {error && (
            <p className="text-center text-[9px] md:text-[10px] font-black text-rose-500 uppercase tracking-widest mt-4">
              ⚠ {error}
            </p>
          )}
        </div>
        ...
        <div className="space-y-6 md:space-y-8">
          <div className="bg-[#0E1C2B] p-8 md:p-10 rounded-[2rem] md:rounded-[3rem] shadow-xl text-white relative overflow-hidden group">
            ...
            <div className="flex items-center gap-3 mb-6 relative z-10">
              <div className="w-8 h-8 md:w-10 md:h-10 bg-white/10 text-white rounded-xl md:rounded-2xl flex items-center justify-center backdrop-blur-md shadow-sm">
                <IoKeyOutline size={18} className="md:size-[22px]" />
              </div>
              <h2 className="text-[10px] md:text-xs font-black uppercase tracking-widest">
                Seguridad
              </h2>
            </div>

            <p className="text-[11px] md:text-xs text-white/60 font-medium mb-6 md:mb-8 leading-relaxed">
              ¿Deseas actualizar tu contraseña? Enviaremos un enlace de recuperación a tu bandeja.
            </p>
            ...
            {resetMsg && (
              <p className="text-center text-[8px] md:text-[9px] font-black uppercase tracking-widest mt-4 text-sky-300 italic">
                {resetMsg}
              </p>
            )}
          </div>
          ...
          <div className="bg-gray-50 p-8 md:p-10 rounded-[2rem] md:rounded-[3rem] border border-gray-100 flex flex-col items-center text-center">
            ...
            <h3 className="text-[11px] md:text-sm font-black text-[#0E1C2B] uppercase tracking-widest mb-2">
              Ayuda & Soporte
            </h3>
            <p className="text-[11px] md:text-xs text-gray-500 font-medium leading-relaxed">
              Si tienes problemas, contacta con el soporte técnico de MIS Academy.
            </p>
          </div>
        </div>
      </div>
