  ...
  useEffect(() => {
    ...
    const cargarDatos = async () => {
      ...
      try {
        ...
        const listaC: Curso[] = resCursos.data || [];
        setCursos(listaC);
      } catch (err) {
        console.error(err);
      } finally {
  ...
  const handleSave = async () => {
    ...
    if (cursoId && orden) {
      try {
        ...
        setErrorOrden('No se pudo validar el orden del módulo.');
        hasError = true;
      }
    }
      ...
      <div className="space-y-6">
        ...
        <div className="p-6 bg-slate-50/40 rounded-[2.5rem] border border-slate-100/50 space-y-6">
          ...
          <div>
            ...
            />
            {errorCurso && (
              <p className="text-[9px] font-bold text-rose-500 uppercase tracking-widest mt-2 ml-1 animate-pulse">
                {errorCurso}
              </p>
            )}
          </div>
          ...
          <div>
            ...
            />
            {errorTitulo && (
              <p className="text-[9px] font-bold text-rose-500 uppercase tracking-widest mt-1 ml-1 animate-pulse">
                {errorTitulo}
              </p>
            )}
          </div>
