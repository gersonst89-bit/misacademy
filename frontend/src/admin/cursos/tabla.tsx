      ...
      {open && (
        <div
          className="
            ...
            bg-white
            rounded-[2rem]
            shadow-[0_30px_60px_rgba(15,23,42,0.15)]
            border
            border-slate-100
            p-2
            z-50
                      ...
                      >
                        ...
                        >
                          {curso.precio != null && !isNaN(Number(curso.precio))
                            ? `S/. ${Number(curso.precio).toLocaleString('es-PE', {
                      ...
                      >
                        ...
                        <button
                          ...
                          className="
                            ...
                            group/btn
                          "
                          title={curso.estado === 'Publicado' ? 'Archivar curso' : 'Publicar curso'}
                          aria-label={
                            curso.estado === 'Publicado'
                              ? `Archivar ${curso.nombre}`
                              : `Publicar ${curso.nombre}`
                          }
                        >
                          <FaArchive
                            size={15}
                  ...
                  >
                    <div
                      className={`
                        ...
                        h-1.5
                        rounded-full
                        ${curso.estado === 'Publicado' ? 'bg-emerald-500' : 'bg-amber-500'}
                      `}
                    />
