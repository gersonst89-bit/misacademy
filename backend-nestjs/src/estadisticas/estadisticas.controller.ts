...
export class EstadisticasController {
  ...
  @Get('estudiantes/por-linea')
  getPorLinea() {
    return this.svc.getEstudiantesPorLinea();
  }

  @Get('estudiantes/por-mes')
  getEstudiantesPorMes() {
    return this.svc.getEstudiantesInscritosPorMes();
  }

  @Get('usuarios/retencion-mensual')
  getRetencion() {
    return this.svc.getRetencionMensual();
  }

  @Get('cursos/mas-vendidos-mes')
  getMasVendidos() {
