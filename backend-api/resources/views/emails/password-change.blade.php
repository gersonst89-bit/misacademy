...
<body style="font-family: Arial, sans-serif; background: #f9f9f9; padding: 30px;">
	<div style="max-width: 500px; margin: auto; background: #fff; border-radius: 8px; box-shadow: 0 2px 8px #eee; padding: 32px;">
		...
		<p>Has solicitado cambiar tu contraseña desde tu cuenta activa.</p>
		<p style="margin: 24px 0; text-align: center;">
			<a href="{{ $url }}" style="background: #4f46e5; color: #fff; padding: 12px 24px; border-radius: 4px; text-decoration: none; font-weight: bold;">Cambiar mi contraseña</a>
		</p>
